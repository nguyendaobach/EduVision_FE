...
const items = [
  ...
  getItem("Setting", "2", <IoIosSettings />),
  getItem("Upgrade", "5", <IoDiamond />),
  getItem("History", "9", <MdHistory />),
];
const Sidebar = () => {
  ...
  return (
    <Layout style={{ minHeight: "100vh" }}>
      ...
      >
        <div>
          <img
            className="rounded-full h-[60px] items-center mx-auto mt-2"
        ...
        <div className="demo-logo-vertical mt-[20px] gap-[100px] " />
        <Menu
          theme="dark"

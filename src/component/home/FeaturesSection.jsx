    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="text-center mb-16">
        <div className="inline-flex items-center px-4 py-2 bg-purple-100 rounded-full mb-6">
          ...
          <span className="text-sm font-medium text-purple-700">Tính năng nổi bật</span>
        </div>

        <h2 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
          Tại sao chọn <span className="bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent">EduVision AI?</span>
        </h2>
        <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
          Công nghệ AI tiên tiến kết hợp với chương trình giáo dục chuẩn, 
          <span className="font-semibold text-purple-600"> giúp bạn tiết kiệm 90% thời gian chuẩn bị bài giảng</span>
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
        ...
        <div className="group relative bg-white rounded-3xl p-8 shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-gray-100">
          ...
          <div className="relative">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">Tạo slide tự động</h3>
            <p className="text-gray-600 mb-6 leading-relaxed">AI phân tích nội dung và tạo slide chuyên nghiệp với layout đẹp mắt, phù hợp với từng môn học</p>
        ...
        <div className="group relative bg-white rounded-3xl p-8 shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-gray-100">
          ...
          <div className="relative">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">Video bài giảng AI</h3>
            <p className="text-gray-600 mb-6 leading-relaxed">Chuyển đổi slide thành video với giọng nói tự nhiên, âm thanh rõ ràng và tốc độ phù hợp</p>
        ...
        <div className="group relative bg-white rounded-3xl p-8 shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-gray-100">
          ...
          <div className="relative">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">Chương trình chuẩn</h3>
            <p className="text-gray-600 mb-6 leading-relaxed">Nội dung được xây dựng theo chương trình giáo dục chính thức, đảm bảo tính chính xác và phù hợp</p>
        ...
        <div className="group relative bg-white rounded-3xl p-8 shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-gray-100">
          ...
          <div className="relative">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">Siêu tốc độ</h3>
            <p className="text-gray-600 mb-6 leading-relaxed">Hoàn thành bài giảng chỉ trong 3-5 phút, nhanh hơn 10x so với phương pháp truyền thống</p>
        ...
        <div className="group relative bg-white rounded-3xl p-8 shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-gray-100">
          ...
          <div className="relative">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">Giao diện thân thiện, không cần kỹ năng thiết kế hay công nghệ, phù hợp với mọi giáo viên</p>
        ...
        <div className="group relative bg-white rounded-3xl p-8 shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-gray-100">
          ...
          <div className="relative">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">Nội dung và công nghệ được cập nhật thường xuyên, luôn bắt kịp xu hướng giáo dục mới nhất</p>

      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 md:p-10 border border-gray-100">
        ...
        {(selectedSubject || selectedGrade || selectedChapter) && (
          <div className="mb-8 p-6 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl border border-purple-200 shadow-sm">
            <h4 className="font-semibold text-purple-900 mb-4 flex items-center">
              <AlertCircle className="w-5 h-5 mr-2 text-purple-700" /> Thông tin
              bài giảng sẽ tạo:
            </h4>
        ...
        <div className="text-center">
            ...
            {isGenerating ? (
              ...
              <>
                ...
                <span className="text-lg">
                  Tạo {selectedMode === "slides" ? "slide" : "video"} bài giảng
                  với AI
                </span>
          ...
          <p className="text-sm text-gray-500 mt-3">
            ⚡ Thời gian tạo:{" "}
            {selectedMode === "slides" ? "1-3 phút" : "3-5 phút"} (tùy thuộc vào
            độ phức tạp)
          </p>
        </div>
          ...
          <div className="mt-8 p-6 bg-white rounded-lg border border-purple-200 shadow-md animate-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-700 font-medium">
                      AI đang tạo{" "}
                      {selectedMode === "slides" ? "slide" : "video"} chuyên
                      nghiệp cho bạn...
                    </span>
                  </div>
            ...
            {!isGenerating && generatedContent && generatedContent.videoUrl && (
              <div className="animate-in fade-in-50 duration-700 delay-300">
                <div className="flex justify-between items-center mb-3">
                  <h4 className="font-medium text-gray-800 flex items-center">
                    <Play className="w-4 h-4 mr-2 text-purple-600" /> Video bài
                    giảng
                  </h4>
                  <a
            ...
            {!isGenerating &&
              generatedContent &&
              (generatedContent.slideUrl || generatedContent.videoUrl) && (

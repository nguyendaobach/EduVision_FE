      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
          ...
          <span className="font-semibold text-indigo-600">
            {" "}
            Chỉ 3 bước đơn giản để có bài giảng hoàn chỉnh
          </span>
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 relative z-10">
          ...
          <div className="group text-center">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Lựa chọn môn học và bài học cụ thể từ danh sách chương trình giáo
              dục chính thức. Hệ thống hỗ trợ đầy đủ các môn từ Tiểu học đến
              THPT.
            </p>
          ...
          <div className="group text-center">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Trí tuệ nhân tạo phân tích yêu cầu và tự động tạo ra slide bài
              giảng với nội dung chính xác, layout chuyên nghiệp và hình ảnh
              minh họa phù hợp.
            </p>
          ...
          <div className="group text-center">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Nhận ngay slide PowerPoint chuyên nghiệp và video bài giảng với
              giọng nói tự nhiên. Sẵn sàng sử dụng cho lớp học hoặc học online.
            </p>
        ...
        <div className="inline-flex items-center space-x-8 bg-white rounded-2xl px-8 py-4 shadow-lg border border-gray-100">
          <div className="flex items-center">
            ...
            <span className="text-sm font-medium text-gray-700">
              Tổng thời gian:{" "}
              <span className="font-bold text-purple-600">3-5 phút</span>
            </span>
          </div>
          ...
          <div className="flex items-center">
            ...
            <span className="text-sm font-medium text-gray-700">
              Chất lượng:{" "}
              <span className="font-bold text-emerald-600">Chuyên nghiệp</span>
            </span>
          </div>
        </div>
      </div>

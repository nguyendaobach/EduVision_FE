...
const HeroSection = () => (
  <section className="relative bg-gradient-to-br from-purple-600 via-purple-500 to-indigo-600 text-white py-32 overflow-hidden min-h-screen flex items-center">
    ...
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center w-full">
      ...
      <div className="inline-flex items-center px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full mb-8 border border-white/20">
        ...
        <span className="text-sm font-medium">Công nghệ AI tiên tiến nhất 2025</span>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300 hover:scale-105">
          ...
          <p className="text-white/80 text-sm">AI tạo slide chuyên nghiệp theo chương trình chuẩn</p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300 hover:scale-105">
          ...
          <p className="text-white/80 text-sm">Tạo video giảng dạy với giọng nói tự nhiên</p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300 hover:scale-105">
          ...
          <p className="text-white/80 text-sm">Hoàn thành trong 3-5 phút, không cần thiết kế</p>
        </div>
      </div>

      {/* CTA Buttons */}
      <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
        <button className="group relative px-10 py-5 bg-gradient-to-r from-yellow-400 to-yellow-500 text-purple-900 rounded-2xl font-bold text-xl transition-all duration-300 hover:from-yellow-300 hover:to-yellow-400 hover:scale-110 hover:shadow-2xl hover:shadow-yellow-400/25 min-w-[250px]">
        ...
        <button className="group px-10 py-5 border-2 border-white/30 text-white rounded-2xl font-semibold text-xl transition-all duration-300 hover:border-white hover:bg-white/10 hover:scale-110 min-w-[250px] backdrop-blur-sm">
          <div className="flex items-center justify-center gap-3">
      ...
      <div className="text-white/70 text-sm">
        ...
        <span className="font-semibold text-yellow-200"> Miễn phí 3 bài giảng đầu tiên</span>
      </div>
    </div>

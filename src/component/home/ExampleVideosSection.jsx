    ...
    slides: [
      {
        ...
        subject: "Toán học",
        grade: "Lớp 9",
        thumbnail: "https://via.placeholder.com/300x200/6366f1/ffffff?text=Slide+Demo",
        duration: "15 slides",
        views: "1.2k",
        rating: 4.8
      },
      {
        ...
        subject: "Sinh học",
        grade: "Lớp 10",
        thumbnail: "https://via.placeholder.com/300x200/10b981/ffffff?text=Slide+Demo",
        duration: "20 slides",
        views: "890",
        rating: 4.9
      },
      {
        ...
        subject: "Lịch sử",
        grade: "Lớp 12",
        thumbnail: "https://via.placeholder.com/300x200/f59e0b/ffffff?text=Slide+Demo",
        duration: "25 slides",
        views: "2.1k",
        rating: 4.7
      }
    ...
    videos: [
      {
        ...
        subject: "Vật lý",
        grade: "Lớp 10",
        thumbnail: "https://via.placeholder.com/300x200/ef4444/ffffff?text=Video+Demo",
        duration: "12:30",
        views: "3.4k",
        rating: 4.9
      },
      {
        ...
        subject: "Hóa học",
        grade: "Lớp 10",
        thumbnail: "https://via.placeholder.com/300x200/8b5cf6/ffffff?text=Video+Demo",
        duration: "18:45",
        views: "2.8k",
        rating: 4.8
      },
      {
        ...
        subject: "Ngữ văn",
        grade: "Lớp 11",
        thumbnail: "https://via.placeholder.com/300x200/06b6d4/ffffff?text=Video+Demo",
        duration: "22:15",
        views: "1.9k",
        rating: 4.6
      }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center px-4 py-2 bg-emerald-100 rounded-full mb-6">
            ...
            <span className="text-sm font-medium text-emerald-700">Nội dung mẫu</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            ...
            <span className="font-semibold text-emerald-600"> Chất lượng chuyên nghiệp, sẵn sàng sử dụng</span>
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {sampleContent[activeTab].map((item) => (
            <div key={item.id} className="group bg-white rounded-3xl shadow-sm hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-gray-100 overflow-hidden">
              {/* Thumbnail */}
        ...
        <div className="text-center">
          ...
          <p className="text-gray-500 mt-4 text-lg">
            🎁 <span className="font-semibold">Miễn phí</span> tạo 3 bài giảng đầu tiên
          </p>
        </div>
      </div>
    </section>
